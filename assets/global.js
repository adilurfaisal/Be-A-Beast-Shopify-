...
if(document.querySelectorAll('[id^="Details-"] summary')){
...
class ModalOpener extends HTMLElement {
  constructor() {
    ...
    const divbtn = this.querySelector('div.modal-btn');
...
class VariantSelects extends HTMLElement {
  ...
  updateMedia() {
    ...
    const mediaPreview = document.getElementById(`GalleryViewer-${this.dataset.section}`)
    const previewImage = mediaPreview.querySelector('.product--preview-image .__image--wrapper img')
    if(this.currentVariant.featured_image.src != null || this.currentVariant.featured_image.src != "") previewImage.src = this.currentVariant.featured_image.src
    const mediaGallery = document.getElementById(`MediaGallery-${this.dataset.section}`);
    mediaGallery.setActiveSlide(this.currentVariant.featured_media.position)
...
//     modalContent.prepend(newMediaModal);
  ...
  renderProductInfo() {
    const colorPosition = this.dataset.colorPosition
    const colorOptionElement = this.querySelector('.__color-option-inputs .option__value')
    colorOptionElement.innerHTML = this.currentVariant[`option${colorPosition}`]
